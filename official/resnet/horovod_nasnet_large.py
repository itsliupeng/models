...
# bypass temp bug
imagenet_preprocessing._RESIZE_MIN = 350
...
def cnn_model_fn(features, labels, mode, params):
    ...
    model = nets_factory.get_network_fn('nasnet_large', 1001, weight_decay=weight_decay, is_training=mode == tf.estimator.ModeKeys.TRAIN)
