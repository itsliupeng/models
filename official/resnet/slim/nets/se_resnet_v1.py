...
def fully_connected(x, units, scope = None, layer_name='fc') :
...
def resnet_v1(inputs,
  ...
  """
  with tf.variable_scope(scope, 'se_resnet_v1', [inputs], reuse=reuse) as sc:
...
resnet_v1.default_image_size = 299
